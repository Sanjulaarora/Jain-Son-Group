...
export function SideNavMob({ role }: SideNavProps) {
  ...
  return (
    <nav className="w-full bg-background border-r border-border block media555:hidden fixed bottom-0 left-0 right-0 shadow-md z-50 mt-8">
      <div className="px-3 py-2">
        <div className="space-y-1 flex justify-around ">
